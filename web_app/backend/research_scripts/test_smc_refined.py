...
def test_smc_refined():
    print("Fetching 4 years of 1h data for SMC (Refined)...")
    ...
    while i < len(df) - 1:
        ...
        if c > e2 and l < lb and v > 1.5 * v_ma:
            ...
            if candle_range > 0:
                ...
                # Rejection AND NOT catching a steep falling knife (< 0.6% drop)
    ...
    print("\n--- 4-YEAR SMART MONEY (REFINED: NO FALLING KNIFE) ---")
