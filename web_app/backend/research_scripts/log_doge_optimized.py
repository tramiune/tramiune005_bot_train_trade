...
def run_analysis():
    ...
    print("\n" + "="*50)
    print("   DOGE RR15 - OPTIMIZED TRADE LOG")
    print("="*50)
    for idx, t in enumerate(final_trades):
        print(f"Trade {idx+1:>2} | {t['date']} | DOGE: ${t['price']:.4f} | {t['result']} ({t['rr']})")
    ...
    print("="*50)
    print(f"Total: {total} Trades | {wins} Wins | {losses} Losses | Winrate: {wins/total*100:.1f}%")
    print(f"Net Profit: {(wins * 15.0) - losses} R")
