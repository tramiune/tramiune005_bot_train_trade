...
def run_analysis():
    ...
    print("\n--- AVAX SUPERTREND + EMA 200 (TRAILING STOP) ---")
    for mult in [2.0, 3.0, 4.0]:
        ...
        i = 205
        while i < len(df) - 1:
            # Signal: ST flips to 1 AND Price is above EMA 200
        ...
        print(f"Mult {mult:>3.1f} | Trades: {total:>3} | Wins: {wins:>3} | Losses: {losses:>3} | WR: {wr:05.2f}% | Profit: {net_R:>+6.1f} R")
