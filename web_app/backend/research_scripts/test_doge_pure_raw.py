...
def run_analysis():
    ...
    while i < len(df) - 1:
        ...
        # PURE RAW CONDITIONS (Only Uptrend, Speed, and Touch)
        ...
        # WE COMPLETELY REMOVED THE PINBAR/REJECTION FILTER (close_pct > 0.6)
        
        if is_uptrend and is_proper_speed and is_touching:
            entry = c
    ...
    print("\n" + "="*50)
    print(" DOGE - PURE RAW BASELINE (Only EMA200 Touch)")
    print(" RR 15.0, StopLoss 1.8 ATR. NO PINBAR FILTER.")
    print("="*50)
